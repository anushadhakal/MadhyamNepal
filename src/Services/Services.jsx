...
const ServiceCard = ({ title, description, icon: Icon, color, path }) => {
  ...
  return (
    ...
    >
      <div className={styles.iconWrapper} style={{ backgroundColor: color }}>
        {/* Render the icon component instead of passing the JSX element */}
        <Icon size={24} />
      </div>
  ...
  const services = [
    {
      ...
      icon: FaHashtag,  // Pass the component, not the JSX element
      color: '#8EC36A',
